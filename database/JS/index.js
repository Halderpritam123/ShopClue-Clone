...
async function fetchandrenderdata(){
    let response=await fetch("https://shop-clue-n8ec.onrender.com/Mobile&Laptop?_limit=6&_page=2");
...
async function gadgetsrenderdata(){
    let response=await fetch("https://shop-clue-n8ec.onrender.com/Homepage?_limit=6&_page=2");
    let res=await response.json();
    console.log(res)
    gadgetcartdata(res)
}
...
async function forbrandstore(){
    let response=await fetch("https://shop-clue-n8ec.onrender.com/Homepage?_limit=6&_page=3");
    let res=await response.json();
    storebrandData(res)
}
